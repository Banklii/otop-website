<?php 
 if(@$_GET['do']=='success'){
    ...
    echo '<meta http-equiv="refresh" content="1;url=re_product.php" />';
...
$query = "SELECT * FROM tbl_re_product as p
...
echo ' <table id="myTable" class="table table-bordered table-striped">';
  ...
  echo "<tr>";
    ...
    echo "<td class='hidden-xs'>"."<img src='../p_img/".$row['p_img']."' width='150px'>"."</td>";
    ...
    "<br>วันที่ ".date('d/m/Y',strtotime($row["datesave"])).
      ...
      "</td> ";
        echo "<td><a href='re_product.php?act=edit&ID=$row[p_id]' class='btn btn-warning btn-xs'><span class='glyphicon glyphicon-edit'></span></a> 
        <a href='re_product_del_db.php?ID=$row[p_id]' onclick=\"return confirm('ยันยันการลบ')\" class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-trash'></span></a>        
    </td> ";
