...
<form action="news_form_edit_db.php" method="post" class="form-horizontal" enctype="multipart/form-data">
  <div class="form-group">
    <div class="col-sm-2 control-label">
      ชื่อ:
    </div>
    <div class="col-sm-3">
      <input type="text" name="n_name" required class="form-control" value="<?php echo $row['n_name'];?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
    <textarea name="n_detail" cols="60"><?php echo $row['n_detail'];?></textarea>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      ภาพเก่า <br>
      <img src="../n_img/<?php echo $row['n_img'];?>" width="200px">
      <br>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
       <input type="hidden" name="n_img2" value="<?php echo $row['n_img'];?>">
