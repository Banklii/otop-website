...
$sql = "SELECT * FROM tbl_re_product as p 
...
$sql2 = "SELECT * FROM tbl_type ORDER BY type_id DESC" or die("Error:" . mysqli_error());
...
<form action="re_product_form_edit_db.php" method="post" class="form-horizontal" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
      ...
      <a href="re_product.php" class="btn btn-danger">ยกเลิก</a>
    </div>
  </div>
</form>